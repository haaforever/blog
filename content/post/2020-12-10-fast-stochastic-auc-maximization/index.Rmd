...
\begin{equation}
\min_{\begin{array}{c} \lVert \mathbf{w} \rVert _1 \leq R \\[-2pt] (a, b) \in \mathbb{R}^2 \end{array}} \; \max_{\alpha \in \mathbb{R}} \; f(\mathbf{w}, a, b, \alpha) := \mathbb{E}_{\mathbf{z}} [F(\mathbf{w}, a, b, \alpha ; z)]
\end{equation}
...
## Alrogithm
  ...
  * Description of values
    ...
    + $R$: upper bound of $\lVert \mathbf{w} \rVert _1$ (*user*)
...
## Experiments
  * Comparison
    ...
    + SOLAM (Ying et al., 2016): $L_2$ norm constraint
    + SOLAM-l1  (Ying et al., 2016): $L_1$ norm constraint (original)
